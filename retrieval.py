# for run command ->  c:\users\adilr\anaconda3\python.exe .\retrieval.py
...
if __name__ == "__main__":
    ...
    query = "What is the most popular in delhi ?"

    prompt_template = PromptTemplate(input_variables = [], template=query)

    vectorstore = PineconeVectorStore(index_name = "rag-project-1", embedding = embeddings)
